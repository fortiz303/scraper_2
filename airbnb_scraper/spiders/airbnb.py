        ...
        for home in homes:
            ...
            try:
                ...
                try:
                    ...
                    try:
                        data_dict[room_id]['price'] = home.get(
                            'pricing_quote').get('structured_stay_display_price').get('secondary_line').get('price').split(" ")[0].replace("$", "")
                    except:
                        logging.warning(
            ...
            try:
                ...
                try:
                    ...
                    try:
                        data_dict[room_id]['currency'] = home.get(
                            'pricing_quote').get('structured_stay_display_price').get('secondary_line').get('price').split(" ")[1]
                    except:
